...
public class HotFragment extends BaseFragment {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        httpListener=new HttpListener<String>() {
            ...
            public void onSuccess(int what, String response) {
                ...
                String data=helper.getContentByKey("hot");
    ...
    public void getDataByVolley(){
        ...
        VolleyHelper.getInstance().add(commDataDao,this, HttpWhatContacts.GETCONTENT, ApiContacts.CIRCLE_HOT,httpListener,paramers,false);
    }
