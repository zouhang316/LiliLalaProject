 ...
 * 497239511@qq.com
 */
public class MarketFragment_temp extends BaseFragment {
    private List<MarketBean> oldBeanList,newBeanList;
            ...
            public void onSuccess(int what, String response) {
                switch (what){
                    case HttpWhatContacts.GETOLD :
                        ...
                        oldAdapter=new MarketOldAdapter(oldBeanList,getContext());
