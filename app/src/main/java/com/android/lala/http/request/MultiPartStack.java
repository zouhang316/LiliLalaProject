...
public class MultiPartStack extends HurlStack {
	...
	public HttpResponse performRequest(Request<?> request,
		...
		if(!(request instanceof MultiPartRequestListener)) {
	...
	/**
	 * If Request is MultiPartRequestListener type, then set MultipartEntity in the
	 * httpRequest object.
	 * 
	 * @param httpRequest
	 * @param request
	...
	private static void setMultiPartBody(HttpEntityEnclosingRequestBase httpRequest,
		...
		// Return if Request is not MultiPartRequestListener
		if (!(request instanceof MultiPartRequestListener)) {
			return;
		}
		...
		Map<String, File> fileUpload = ((MultiPartRequestListener) request).getFileUploads();
		...
		Map<String, String> stringUpload = ((MultiPartRequestListener) request).getStringUploads();
